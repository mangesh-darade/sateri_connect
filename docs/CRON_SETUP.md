...
Replace `/path/to/sateri_connect` with your install path, e.g.:

```
/Applications/XAMPP/xamppfiles/htdocs/sateri_connect
```
...
```cron
* * * * * cd /Applications/XAMPP/xamppfiles/htdocs/sateri_connect && /Applications/XAMPP/xamppfiles/bin/php spark queue:process >> writable/logs/cron-queue.log 2>&1
* * * * * cd /Applications/XAMPP/xamppfiles/htdocs/sateri_connect && /Applications/XAMPP/xamppfiles/bin/php spark campaigns:process >> writable/logs/cron-campaigns.log 2>&1
* * * * * cd /Applications/XAMPP/xamppfiles/htdocs/sateri_connect && /Applications/XAMPP/xamppfiles/bin/php spark automations:process >> writable/logs/cron-automations.log 2>&1
* * * * * cd /Applications/XAMPP/xamppfiles/htdocs/sateri_connect && /Applications/XAMPP/xamppfiles/bin/php spark queue:retry >> writable/logs/cron-retry.log 2>&1
```

### Daily jobs (03:15 server time)

```cron
15 3 * * * cd /Applications/XAMPP/xamppfiles/htdocs/sateri_connect && /Applications/XAMPP/xamppfiles/bin/php spark templates:sync >> writable/logs/cron-templates.log 2>&1
20 3 * * * cd /Applications/XAMPP/xamppfiles/htdocs/sateri_connect && /Applications/XAMPP/xamppfiles/bin/php spark logs:cleanup 30 >> writable/logs/cron-cleanup.log 2>&1
```
...
```cron
* * * * * /Applications/XAMPP/xamppfiles/htdocs/sateri_connect/bin/cron-minute.sh >> /Applications/XAMPP/xamppfiles/htdocs/sateri_connect/writable/logs/cron-minute.log 2>&1
```
...
2. Action: start program  
   ...
   - Start in: `C:\xampp\htdocs\sateri_connect`  
...
```bash
cd /Applications/XAMPP/xamppfiles/htdocs/sateri_connect
...
```cron
* * * * * flock -n /tmp/sateri_connect-queue.lock -c 'cd /path/to/sateri_connect && php spark queue:process' >> writable/logs/cron-queue.log 2>&1
```
